...
<body>
    <div id="app">
        <div class="head_com">
            <div class="hederbg">
                ...
                <h1>收货地址</h1>
                <a href="{{url('wap/user/addAddress')}}" class="sousuo">添加</a>
            </div>
        </div>
        ...
        <div class="addressList" style="display: none">
            <ul>
                <li v-for="(item,index) in list">
                    ...
                    <div class="address-edit" @click="edit(item.id)">编辑</div>
                </li>
            </ul>
        </div>
	</div>
    ...
    <script type="text/javascript " src="/mobile/js/recevingAddress.js "></script>
</body>
</html>