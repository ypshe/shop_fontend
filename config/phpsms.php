...
return [
    ...
    'agents' => [
        ...
        'Alidayu' => [
            ...
            'appKey'            => 'LTAImnTPopNZk7On',
            //淘宝开放平台中，对应阿里大鱼短信应用的App Secret
            'secretKey'         => 'm060ck5XRGyu9L1C00KXRem3VjhFJN',
            //短信签名，传入的短信签名必须是在阿里大鱼“管理中心-短信签名管理”中的可用签名
            'smsFreeSignName'   => '117147870',
         ...
         */
        'Aliyun' => [
            'accessKeyId'       => 'LTAImnTPopNZk7On',
            'accessKeySecret'   => 'm060ck5XRGyu9L1C00KXRem3VjhFJN',
            'signName'          => '佘永攀',
